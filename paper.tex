...
\item The parties calculate \(\phi = t * \langle z_1 \rangle\ - \langle z_2 \rangle - \sigma * \langle x_2 \rangle - p * \langle y_2 \rangle - \sigma * p)\) and the partially open the result
...
So we can see that \( \phi = 0 \Leftrightarrow x_1*y_1 = z_1 \and x_2*y_2=z_2 \), so we know the triple is correct. \\
