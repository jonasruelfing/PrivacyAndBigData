...
An access structures contains the information which subsets of parties are allowed to combine their information to discover the secret. In the literature this subset of parties is called qualified set.  An access structure is called \(Q_l \) if at least l+1 parties are needed to  form a qualified set. 
