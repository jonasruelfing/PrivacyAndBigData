...
\begin{enumerate}
\item Choose a random variable \(t\) and open it to the other parties. This is done by each party generating a random share \(r_i\) and then calculating \(r=r_1+...+r_n)\
\item 
\item 
\item 
